        ...
        <div class="card" >
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group d-flex">
                            ...
                            <input type="checkbox" id="switch1" switch="none" name="status" {{ old('status', isset($unit->status) ? $unit->status : '')=='active' ? 'checked':'' }}/>
                ...
                <div class="row mt-2 justify-content-center">
                    <div class="form-group">
                        <div>
                            <a class="btn btn-light waves-effect ml-1" href="{{ route('unit.index') }}">

        ...
        <div class="card" >
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group d-flex">
                            ...
                            <input type="checkbox" id="switch1" switch="none" name="status" {{ old('status', isset($brand->status) ? $brand->status : '')=='active' ? 'checked':'' }}/>
                            <label for="switch1" class="ml-auto" data-on-label="On" data-off-label="Off"></label>
                        </div>
                        <div class="form-group d-flex" >
                            <span class="pl-1">Availability</span>
                            <input type="checkbox" id="switch2" switch="none" name="availability" {{ old('availability', isset($brand->availability) ? $brand->availability : '')=='available' ? 'checked':'' }}/>
                            <label for="switch2" class="ml-auto" data-on-label="On" data-off-label="Off"></label>
                        </div>
                        <div class="form-group d-flex">
                            <span class="pl-1" >Featured</span>
                            <input type="checkbox" id="switch3" switch="none" name="visibility" {{ old('visibility', isset($brand->visibility) ? $brand->visibility : '')=='visible' ? 'checked':'' }}/>
                ...
                <div class="row mt-2 justify-content-center">
                    <div class="form-group">
                        <div>
                            <a class="btn btn-light waves-effect ml-1" href="{{ route('brand.index') }}">
